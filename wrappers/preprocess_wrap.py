...
def preprocess_wrap(fasta_dir, output_dir, output_base_qual, chunk_size, threads):
    ...
    if len(files_to_process) == 1:
        ...
        extract_and_bin_reads(files_to_process[0], chunk_size, output_dir + "/full_length_pp_fa", output_base_qual)
        ...
        parallel_preprocess_data(
            files_to_process, output_dir + "/full_length_pp_fa", chunk_size, output_base_qual, num_workers=threads
        )
